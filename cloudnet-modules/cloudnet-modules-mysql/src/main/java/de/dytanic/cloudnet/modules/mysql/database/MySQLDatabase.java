...
final class MySQLDatabase implements IDatabase {
    ...
    public MySQLDatabase(String name, MySQLDatabaseProvider databaseProvider)
    {
    ...
    public boolean insert(String key, Document document)
    {
        ...
        databaseProvider.call(new Consumer<IDatabaseListener>() {
            ...
            {
                listener.onInsert(MySQLDatabase.this, key, document);
            }
        });
    ...
    public boolean delete(String key)
    {
        ...
        databaseProvider.call(new Consumer<IDatabaseListener>() {
            ...
            public void accept(IDatabaseListener listener)
            {
                listener.onDelete(MySQLDatabase.this, key);
            }
        });
    ...
    public boolean update(String key, Document document)
    {
        ...
        databaseProvider.call(new Consumer<IDatabaseListener>() {
            ...
            public void accept(IDatabaseListener listener)
            {
                listener.onUpdate(MySQLDatabase.this, key, document);
            }
        });
    ...
    public Document select(String key)
    {
        ...
        try (Connection connection = this.databaseProvider.dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT Document FROM " + name + " WHERE Name=?"))
        {
    ...
    public Map<String, Document> entries()
    {
        ...
        try (Connection connection = databaseProvider.dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM " + this.name);
    ...
    public Collection<String> keys()
    {
        ...
        try (Connection connection = this.databaseProvider.dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT Name FROM " + this.name);
             ResultSet resultSet = preparedStatement.executeQuery())
        {
    ...
    public Collection<Document> getDocuments()
    {
        ...
        try (Connection connection = this.databaseProvider.dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT Document FROM " + this.name);
             ResultSet resultSet = preparedStatement.executeQuery())
        {
    ...
    public void clearDatabase()
    {
        ...
        try (Connection connection = databaseProvider.dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("DELETE FROM " + name + " WHERE NAME=?"))
        {
            for (String key : keys)
            {
                preparedStatement.setString(1, key);
