...
public class TaskScheduler {
    ...
    protected final String name = "TaskScheduler-Logger@" + new Random().nextInt(Integer.MAX_VALUE - 1);
    ...
    public TaskScheduler(int maxThreads, Collection<TaskEntry<?>> entries, Logger logger, long sleepThreadSwitch, boolean dynamicThreadCount, long threadLiveMillis)
    {
        ...
        this.logger = logger != null ? logger : Logger.getLogger(name);
    ...
    public class Worker extends Thread {
        ...
        Worker()
        {
            super(name + "#" + threadId.addAndGet(1));
            setDaemon(true);
        }
